/* MirandaQQ3
 * Copyright(C) 2005-2009 Studio KUMA. Written by Stark Wong.
 *
 ...
 * This plugin utilizes the MyQQ library. Copyright(C) Huang Guan
...
#endif
		PLUGINVERSION,
		"MirandaQQ Protocol 2009 Build (Preview Version - " __DATE__ " " __TIME__")",
		"Stark Wong",
...
tagPROTO_INTERFACE* CNetwork::InitAccount(LPCSTR szModuleName, LPCTSTR szUserName) {
	/*
	if (g_networks.size()>=2) {
		MessageBox(NULL,L"This preview version of MirandaQQ3 is limited to 2 accounts to prevent abuse.",NULL,MB_ICONERROR|MB_SYSTEMMODAL);
		return NULL;
	}
	*/
