...
public:
	...
	GroupNameOpReplyPacket(qqclient* client, unsigned char* buf, int len);
...
#if 0 // This OPCODE no longer exists
...
public:
	...
	DownloadGroupFriendReplyPacket(qqclient* client, unsigned char* buf, int len);
...
public:
	...
	UploadGroupFriendReplyPacket(qqclient* client, unsigned char* buf, int len);
