...
public:
	EvaPicPacket(){};
	EvaPicPacket(qqclient* client, unsigned char *buf, int len);
	...
	EvaPicPacket(qqclient* client, unsigned char *buf, int *len, const int cryptStart);
	...
	*/
	...
	void setQQClient(qqclient* client) { m_client=client; }
protected:
...
public:
	EvaPicInPacket() {}
	EvaPicInPacket(qqclient* client, unsigned char *buf, int len);
	EvaPicInPacket(qqclient* client, unsigned char *buf, int len, const int cryptStart);
