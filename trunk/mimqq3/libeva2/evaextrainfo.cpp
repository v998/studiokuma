...
RequestExtraInfoReplyPacket::RequestExtraInfoReplyPacket(qqclient* client, unsigned char *buf, int len)
...
SignatureReplyPacket::SignatureReplyPacket(qqclient* client, unsigned char * buf, int len )
	: InPacket(client, buf, len)
{
}
