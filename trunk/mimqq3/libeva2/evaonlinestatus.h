...
public:
	...
	GetOnlineFriendReplyPacket(qqclient* client, unsigned char *buf, int len);
...
public:
	...
	FriendChangeStatusPacket(qqclient* client, unsigned char* buf, int len);
...
public: 
	...
	ChangeStatusReplyPacket(qqclient* client, unsigned char *buf, int len);
