...
enum {
	...
	QQ_RECV_IM_APPLY_ADD_TO_QUN = 0x0054 /*x0x0023*/,
...
void prot_im_send_msg_ex_format( struct qqclient* qq, uint to, char* msg, int len, ushort msg_id, uchar slice_count, uchar which_piece, char* fontname, int fontsize, uchar bold, uchar italic, uchar underline, uchar red, uchar green, uchar blue  );
