...
DownloadGroupFriendReplyPacket::DownloadGroupFriendReplyPacket(qqclient* client, unsigned char* buf, int len)
	: InPacket(client, buf, len)
{	
}
...
UploadGroupFriendReplyPacket::UploadGroupFriendReplyPacket(qqclient* client, unsigned char* buf, int len)
	: InPacket(client, buf, len)
{
}
