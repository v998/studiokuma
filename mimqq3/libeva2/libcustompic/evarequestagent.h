...
public:
	...
	const unsigned char *getFileAgentToken() const { return m_client->data.file_token.data /*fileAgentKey*/; }
	const unsigned short getTokenLength() const { return m_client->data.file_token.len; }
protected:
...
public:
	...
	RequestAgentReplyPacket(qqclient* client, unsigned char *buf, int len);
