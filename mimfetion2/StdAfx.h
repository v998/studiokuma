...
#if _MSC_VER < 1400
#error You must compile MIMFetion2 using Visual Studio 2005 or above because STL in older compilers does not handle wchar_t correctly.
#endif

#ifndef _UNICODE
#error This version of MIMFetion2 must be built with Unicode enabled
#endif
...
#pragma message("Build of MIMFetion2 Started on " __DATE__ " " __TIME__)
#pragma message("====================")
...
#pragma message("Processing: LibWebFetion")
#include <Wininet.h>
#include <Shlwapi.h>
#include <math.h>
