...
namespace MIMTranslator
{
    interface Engine_Interface
    {
        ...
        void ReadConfig(XmlDocument xd, XmlNodeList whiteNodeList, XmlNodeList blackNodeList, XmlNodeList superNodeList);
        ArrayList ProcessFile(string filename, StreamReader sr);
    }
}
